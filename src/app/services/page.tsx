    ...
    <>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">Our integrated business model enables us to offer seamless, single-source solutions</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {servicesData.map((service) => (
              <div
                key={service.id}
                id={service.id}
                className="card-white p-7 cursor-pointer group"
                onClick={() => setActiveService(activeService === service.id ? null : service.id)}
              >
                <div className="w-11 h-11 rounded-xl bg-[#052e16] flex items-center justify-center mb-4">
                ...
                <div className="flex items-center gap-2 text-[#14532d] font-semibold text-sm">
                  ...
                  <svg className={`w-4 h-4 transition-transform duration-300 ${activeService === service.id ? "rotate-180" : ""}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-14">
            <div className="gold-line mx-auto mb-5" />
            <h2 className="text-3xl font-bold text-[#1a1a1a] mb-3">Why Choose APVIA Ltd</h2>
          </div>

          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: "Integrated Solutions", desc: "Single-source convenience across multiple complementary sectors." },
              { title: "Local Market Knowledge", desc: "Deep understanding of the West African business environment." },
              { title: "International Standards", desc: "Adherence to international quality, safety, and environmental standards." },
              { title: "Strategic Location", desc: "Headquartered in Freetown with access to a natural deep-water harbor." },
              { title: "Financial Strength", desc: "Diversified revenue streams and proven track record of project delivery." },
              { title: "Ethical Practices", desc: "Strong corporate governance and commitment to sustainability." },
            ].map((item) => (
      ...
      <section className="py-24 bg-[#052e16]">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <h2 className="text-3xl font-bold text-white mb-5">Ready to Start Your Project?</h2>
          <p className="text-white/60 text-lg mb-8">Contact us today to discuss how APVIA Ltd can deliver integrated solutions for your next project.</p>
