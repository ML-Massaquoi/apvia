...
export const investmentSectors = [
  ...
  },
  {
    ...
    shortDesc: "Commercial poultry farming, hatchery operations, and processed chicken production for domestic and export markets.",
    icon: "M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z",
    modalTitle: "Poultry Farming & Processing Investment Opportunity",
    overview:
      "Sierra Leone's poultry sector presents a compelling investment opportunity driven by a growing population of 8 million+ with increasing demand for affordable protein. The country currently imports a significant portion of its poultry products, creating a massive gap for local production. APVIA's poultry division operates integrated farming, hatchery, feed milling, and processing operations — positioning the company to capture value across the entire poultry value chain. With rising urbanization, a growing middle class, and government support for local food production, the sector offers strong growth potential and attractive returns for investors.",
    highlights: [
      { label: "Population", value: "8M+", desc: "Growing population with increasing demand for affordable protein sources" },
      { label: "Import Gap", value: "60%+", desc: "Majority of poultry products currently imported — massive local production opportunity" },
      { label: "Urbanization", value: "4.2% pa", desc: "Annual urbanization rate driving demand for processed and packaged poultry" },
      { label: "Feed Cost", value: "Low", desc: "Access to local feed ingredients including maize, soy, and rice bran" },
      { label: "Govt Support", value: "Tax Holiday", desc: "Government incentives for agro-processing and food security investments" },
      { label: "ROI Period", value: "2-4 yrs", desc: "Fast payback period due to high demand and low input costs" },
    ],
    chart: {
      type: "pie" as const,
      title: "Poultry Value Chain Revenue Split",
      data: [
        { name: "Day-Old Chicks", value: 15, color: "#052e16" },
        { name: "Live Birds", value: 20, color: "#14532d" },
        { name: "Processed Chicken", value: 35, color: "#d97706" },
        { name: "Feed Production", value: 20, color: "#166534" },
        { name: "Eggs", value: 10, color: "#fbbf24" },
      ],
    },
  },
  {
...
export const servicesContent = [
  ...
  },
  {
    ...
    title: "Poultry Farming & Processing",
    description:
      "Integrated poultry operations spanning hatchery, feed milling, farming, and processed chicken production for domestic and export markets.",
    icon: "sprout",
    services: [
      "Hatchery Operations producing day-old chicks",
      "Commercial Broiler Farming at scale",
      "Layer Operations for egg production",
      "Feed Milling with locally sourced ingredients",
      "Slaughterhouse and Processing Plant operations",
      "Cold Chain Logistics for fresh and frozen products",
      "Distribution to retail, hotels, and restaurants",
      "Veterinary and Health Management services",
    ],
    capabilities: [
      "Integrated value chain from hatchery to processing",
      "International food safety and hygiene standards",
      "Locally sourced feed reducing import dependency",
      "Cold storage and distribution infrastructure",
      "Quality assurance and traceability systems",
    ],
    overview:
      "APVIA's Poultry division operates an integrated value chain from hatchery to processed chicken products. Sierra Leone's population of 8 million+ with rising urbanization and growing demand for affordable protein creates a significant market gap — the country currently imports over 60% of its poultry products. Our operations include day-old chick production, commercial broiler and layer farming, feed milling with locally sourced maize and soy, and a modern processing plant for fresh and frozen chicken. With government incentives for agro-processing and food security investments, the sector offers attractive returns with a fast payback period.",
    highlights: [
      { label: "Population", value: "8M+", desc: "Growing population with increasing demand for affordable protein" },
      { label: "Import Gap", value: "60%+", desc: "Majority of poultry imported — massive local production opportunity" },
      { label: "Feed Source", value: "Local", desc: "Maize, soy, and rice bran sourced locally at competitive costs" },
      { label: "Processing", value: "Full", desc: "Slaughterhouse, deboning, packaging, and cold storage facilities" },
      { label: "Govt Incentive", value: "Tax Holiday", desc: "Government support for agro-processing and food security" },
      { label: "ROI Period", value: "2-4 yrs", desc: "Fast payback due to high demand and low input costs" },
    ],
    chart: {
      type: "pie" as const,
      title: "Revenue by Poultry Product",
      data: [
        { name: "Processed Chicken", value: 35, color: "#052e16" },
        { name: "Day-Old Chicks", value: 20, color: "#14532d" },
        { name: "Feed Production", value: 20, color: "#d97706" },
        { name: "Live Birds", value: 15, color: "#166534" },
        { name: "Eggs", value: 10, color: "#fbbf24" },
      ],
    },
  },
...
export const mineralVideos = [
  {
    ...
    desc: "Vast arable farmland with sustainable farming potential",
    modalTitle: "Agricultural Investment Opportunity",
    modalDescription:
      "Sierra Leone has 5.4 million hectares of arable land, of which only 15% is currently cultivated. The agricultural sector employs 60% of the workforce and contributes 23% to GDP. High-demand exports include cocoa, coffee, palm oil, and cashew nuts. Our farming operations integrate modern techniques with traditional knowledge for maximum yield, supported by government tax holidays and duty-free import of farm machinery.",
    facts: [
      { label: "Arable Land", value: "5.4M ha" },
      { label: "Cultivated", value: "15%" },
      { label: "GDP Share", value: "23%" },
      { label: "Workforce", value: "60%" },
      { label: "Export Growth", value: "22% YoY" },
  ...
  },
  {
    ...
    title: "Energy & Power",
    desc: "Oil, gas, and renewable energy solutions driving national growth",
    modalTitle: "Energy & Power Investment Opportunity",
    modalDescription:
      "Sierra Leone's energy sector represents a multi-billion dollar opportunity with a current electrification rate of just 26%. Recent offshore discoveries have found billions of barrels of oil, transforming the country's energy outlook. The National Energy Plan targets 1GW of new capacity by 2030 through renewables, while Independent Power Producer frameworks now welcome international investment in both oil & gas and clean energy projects.",
    facts: [
      { label: "Oil Discovery", value: "Billions bbl" },
      { label: "Target Capacity", value: "1 GW" },
      { label: "Electrification", value: "26%" },
      { label: "Market Size", value: "$4.2B" },
      { label: "IPP Licenses", value: "12 Issued" },
      { label: "Solar Hours", value: "2,000+/yr" },
    ],
  },
  {
    src: "/videos/flagship-3.mp4",
    title: "Urban & Rural Electrification",
    desc: "Bringing power to cities and communities across Sierra Leone",
    modalTitle: "National Electrification Projects",
    modalDescription:
      "With a current electrification rate of just 26%, Sierra Leone presents massive opportunities in both urban and rural electrification. Our mini-grid, off-grid, and grid extension solutions bring reliable power to underserved cities and communities, transforming lives and enabling economic activity. Each project is structured with guaranteed off-take agreements and community benefit programs.",
    facts: [
      { label: "Electrification", value: "26%" },
      { label: "Urban Access", value: "35%" },
      { label: "Rural Access", value: "8%" },
      { label: "Mini-Grid Sites", value: "200+" },
      { label: "Households", value: "15,000+" },
      { label: "Carbon Reduced", value: "40%" },
    ],
  },
  {
    src: "/videos/flagship-4.mp4",
    title: "Natural Mineral Landscape",
    desc: "Rich geological formations with untapped mineral wealth",
    modalTitle: "Sierra Leone's Mineral Wealth",
    modalDescription:
      "Sierra Leone sits on one of Africa's richest mineral belts with an estimated $10 billion in untapped mineral wealth. The country is the 7th largest diamond producer globally and holds the world's largest rutile deposits. Our mining operations leverage modern extraction technology while maintaining the highest ESG standards with traceable supply chains.",
    facts: [
      { label: "Mineral Value", value: "$10B+" },
      { label: "Diamond Rank", value: "#7 Global" },
