...
export const mineralVideos = [
  ...
  },
  {
    ...
    desc: "Bringing power to communities across Sierra Leone",
    modalTitle: "Community Electrification Projects",
    modalDescription:
      "With a current electrification rate of just 26%, Sierra Leone presents massive opportunities in rural and community electrification. Our mini-grid and off-grid solutions bring reliable power to underserved communities, transforming lives and enabling economic activity. Each project is structured with guaranteed off-take agreements and community benefit programs.",
    facts: [
      { label: "Electrification", value: "26%" },
      { label: "Mini-Grid Sites", value: "200+" },
      { label: "Communities Served", value: "50+" },
      { label: "Households Connected", value: "15,000+" },
